...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sessions/{id}/differential-dx",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get differential diagnosis
     ...
     Retrieve AI-generated differential diagnosis with possible conditions, likelihood scores, and
    supporting evidence based on the consultation.

    Args:
        id (str): Unique identifier for the consultation session
        use_language_translate (Union[None, Unset, bool]): Whether to translate differential
            diagnosis using consultation's default language Default: False.
