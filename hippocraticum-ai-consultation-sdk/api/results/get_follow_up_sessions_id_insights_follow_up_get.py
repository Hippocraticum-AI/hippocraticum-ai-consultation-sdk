...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sessions/{id}/insights/follow_up",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get follow-up recommendations
     ...
     Retrieve AI-generated follow-up recommendations including medication adjustments, referrals, next
    appointments, and additional tests based on the consultation.

    Args:
        id (str): Unique identifier for the consultation session
        use_language_translate (Union[None, Unset, bool]): Whether to translate follow-up
            recommendations using consultation's default language Default: False.
