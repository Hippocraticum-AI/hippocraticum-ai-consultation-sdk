...
def sync_detailed(
    ...
    *,
    ...
    """Get extracted symptoms
     ...
     Retrieve AI-extracted symptoms and clinical findings from the consultation. Includes patient-
    reported symptoms and clinician observations.

    Args:
        id (str): Unique identifier for the consultation session
        use_language_translate (Union[None, Unset, bool]): Whether to translate symptoms using
