...
def sync_detailed(
    ...
    *,
    ...
    """Get AI-generated insights
     ...
     Retrieve AI-powered insights from the consultation including clinical observations, patient
    assessment, and key medical findings extracted from the conversation.

    Args:
        id (str): Unique identifier for the consultation session
        use_language_translate (Union[None, Unset, bool]): Whether to translate insights using
