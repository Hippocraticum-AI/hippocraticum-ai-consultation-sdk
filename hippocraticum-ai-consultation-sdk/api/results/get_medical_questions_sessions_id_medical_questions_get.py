...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sessions/{id}/medical-questions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get suggested medical questions

     Retrieve AI-generated medical questions that the clinician should consider asking the patient for a
    more complete assessment.

    Args:
        id (str): Unique identifier for the consultation session
        use_language_translate (Union[None, Unset, bool]): Whether to translate medical questions
            using consultation's default language Default: False.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PydanticGetConsultationQuestionsResponse]
    """
